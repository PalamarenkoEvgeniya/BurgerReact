            ...
            <ul className="catalog__list">
              <li className="catalog__item">
                <article className="product">
                  ...
                  <p className="product__price">689
              ...
              <li className="catalog__item">
                <article className="product">
                  ...
                  <p className="product__price">550
                    <span className="currency">₽</span>
                  </p>
              ...
              <li className="catalog__item">
                <article className="product">
                  ...
                  <p className="product__price">639
                    <span className="currency">₽</span>
                  </p>
              ...
              <li className="catalog__item">
                <article className="product">
                  ...
                  <p className="product__price">480
                    <span className="currency">₽</span>
                  </p>
              ...
              <li className="catalog__item">
                <article className="product">
                  ...
                  <p className="product__price">450
                    <span className="currency">₽</span>
                  </p>
              ...
              <li className="catalog__item">
                <article className="product">
                  ...
                  <p className="product__price">560
                    <span className="currency">₽</span>
                  </p>
